...
let favoriteFoods = ['chips', 'salsa', 'pizza', 'sandwiches', 'fruit'];
...
console.log('I have ', favoriteFoods.length, ' different foods on my list.');
...
favoriteFoods.unshift('aussie bites');
